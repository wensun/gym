...
- In mujoco, there are swimmer (SwimmerDiscrete-v2) and reacher (ReacherDiscrete-v2) with multidiscrete action space
- In robotics, there is fetch push (FetchPushDiscrete-v1) with multidiscrete action space
